...
if __name__ == "__main__":
    ...
    agent = DQNAgent(Q, Q_target, nr_actions, discount_factor=0.95, batch_size=batch_size,epsilon=0.05,epsilon_decay=0.95, epsilon_min=0.05,tau=0.5, game='carracing',explore_type="boltzmann", history_length=history_length)
