...
def train_online(env, agent, skip_frames,num_episodes,max_timesteps, history_length=0, model_dir="./models_carracing", tensorboard_dir="./tensorboard"):
    ...
    for i in range(num_episodes):
        ...
        stats = run_episode(env, agent,deterministic= False,skip_frames = skip_frames, do_training=True,rendering = False,max_timesteps=max_timesteps,history_length = history_length)
        ...
        if i % 100 == 0 or i >= (num_episodes - 1):
            ...
            agent.saver.save(agent.sess, os.path.join(model_dir, "dqn_agent_carracing.ckpt"))
