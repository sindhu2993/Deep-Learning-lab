...
def train_online(env, agent, num_episodes, model_dir="./models_cartpole", tensorboard_dir="./tensorboard"):
    ...
    tensorboard = Evaluation(os.path.join(tensorboard_dir, "train"), ["episode_reward", "det_episode_reward" , "a_0", "a_1"])
...
if __name__ == "__main__":
    ...
    Q = NeuralNetwork(state_dim=state_dim, num_actions=num_actions, hidden=300, lr=1e-3)
